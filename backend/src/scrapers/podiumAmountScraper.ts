...
export async function scrape(onProgress?: (team: any) => void) {
    ...
    for (let i = 0; i < equipes?.length; i++) {
        ...
        if (onProgress) onProgress(teamData);
        // verbose:
        //console.log(`${teamData.name}: Top 1: ${podium1} | Top 2: ${podium2} | Top 3: ${podium3} | Total: ${total}`);
    }
